...
-- Insertar datos en Directors
INSERT INTO directors (cuit, institute_id, name, lastname, phone, mail, enabled)
VALUES
('20-12345678-9', 1, 'Alejandro', 'González', '1122334455', 'alejandro.gonzalez@example.com', TRUE),
('20-98765432-1', 2, 'Lucía', 'Martínez', '9988776655', 'lucia.martinez@example.com', TRUE),
('23-11223344-6', 1, 'Sofía', 'López', '6677889900', 'sofia.lopez@example.com', FALSE);
